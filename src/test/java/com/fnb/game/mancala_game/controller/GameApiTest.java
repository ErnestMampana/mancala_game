...
public class GameApiTest {
    ...
    public void shouldInitGame() throws Exception {
        ...
        MockHttpServletRequestBuilder initGameRequest = MockMvcRequestBuilders.post("/api/mancala/games");
        ...
        mockMvc.perform(initGameRequest)
                ...
                //check game state
                .andExpect(MockMvcResultMatchers.jsonPath("$.gameStatus").value("INITIALIZE_GAME"))
    ...
    public void shouldPlayGame() throws Exception {
        ...
        MockHttpServletRequestBuilder playGame = MockMvcRequestBuilders.put("/api/mancala/games/"+game.getId()+"/pits/"+ 1);
